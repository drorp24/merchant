      ...
      >
        <div className="row">
          <div className="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-md m-b-15">
            <p style={{ marginLeft: 60, fontWeight: 500 }}>BarChart of positive and negative values</p>
          ...
          <div className="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-md m-b-15">
            <p style={{ marginLeft: 60, fontWeight: 500 }}>Simple BarChart</p>
            <div style={styles.chartSize}>
              <ResponsiveContainer>
                <BarChart
                  data={data01}
        ...
        <div className="row">
          <div className="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-md m-b-15">
            <p style={{ marginLeft: 60, fontWeight: 500 }}>BarChart of layout vertical</p>
            <div style={styles.chartSize}>
              <ResponsiveContainer>
                <BarChart
                  data={data01}
          ...
          <div className="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-md m-b-15">
            <p style={{ marginLeft: 60, fontWeight: 500 }}>Stack BarChart</p>
            <div style={styles.chartSize}>
              <ResponsiveContainer>
